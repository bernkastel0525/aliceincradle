/*!
 这段代码是GreenSock动画平台（GSAP）的核心代码，它定义了GSAP的版本、许可证、作者和一些常用的工具函数。它还定义了一个名为“css”的插件，该插件允许使用CSS属性来创建动画。该插件还包括一些常见的CSS属性别名和单位，以及一些特殊的CSS属性，如“transform”和“transform-origin”。此外，该代码还注册了一些缓动函数，如“Linear”、“Quad”、“Cubic”等，这些函数可以用于创建动画的缓动效果。最后，该代码将所有这些功能打包到一个名为“gsap”的对象中，以便在其他地方使用。 
 */
